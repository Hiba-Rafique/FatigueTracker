...
export default function LandingPage() {
  ...
  const getCardClass = (index) => {
    ...
    if (index === (activeIndex === 0 ? 2 : activeIndex - 1)) return styles.leftCard;
    if (index === (activeIndex === 2 ? 0 : activeIndex + 1)) return styles.rightCard;
    return '';
  };
      ...
      <main className={styles.hero}>
        ...
        <div className={styles.carouselWrapper}>
          ...
          <div className={styles.mockupContainer}>
            ...
            <BrowserMockup title="Counselor Workspace" className={getCardClass(0)}>
            ...
            <BrowserMockup title="Student Log" className={getCardClass(1)}>
            ...
            <BrowserMockup title="Faculty Portal" className={getCardClass(2)}>
